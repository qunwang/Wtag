...
class doFit_wj_and_wlvj:
    ...
    def __init__(self, in_channel,in_signal_sample, in_mlvj_signal_region_min=500, in_mlvj_signal_region_max=700, in_mj_min=60, in_mj_max=140, in_mlvj_min=700., in_mlvj_max=5000., fit_model="ErfExp_v1", fit_model_alter="ErfPow_v1", input_workspace=None):
...
#        else:
    ...
    def make_Pdf(self, label, in_model_name, mass_spectrum="_mj", ConstraintsList=[],ismc = 0):
        ...
        if in_model_name == "DoubleCB_v1":
            ...
            #        rrv_n2_CB     = RooRealVar("rrv_n2_CB"+label+"_"+self.channel+"_"+self.wtagger_label,"rrv_n2_CB"+label+"_"+self.channel+"_"+self.wtagger_label,20.,0.01,35);
            #        rrv_alpha1_CB = RooRealVar("rrv_alpha1_CB"+label+"_"+self.channel+"_"+self.wtagger_label,"rrv_alpha1_CB"+label+"_"+self.channel+"_"+self.wtagger_label,3,0.5,6.);
            if label_tstring.Contains("1000"):#because the M_ljv lower limit is 800GeV, so, just use right side 
                rrv_mean_CB  = RooRealVar("rrv_mean_CB"+label+"_"+self.channel+"_"+self.wtagger_label,"rrv_mean_CB"+label+"_"+self.channel+"_"+self.wtagger_label,1000,500,3500);
                rrv_sigma_CB = RooRealVar("rrv_sigma_CB"+label+"_"+self.channel+"_"+self.wtagger_label,"rrv_sigma_CB"+label+"_"+self.channel+"_"+self.wtagger_label, 50,20 ,120);
        ...
        if in_model_name == "ErfExp" :
            ...
            rrv_offset_ErfExp = RooRealVar("rrv_offset_ErfExp"+label+"_"+self.channel,"rrv_offset_ErfExp"+label+"_"+self.channel,42.,30.,80);
            rrv_width_ErfExp  = RooRealVar("rrv_width_ErfExp"+label+"_"+self.channel,"rrv_width_ErfExp"+label+"_"+self.channel,10.,1., 20.);
        ...
        if in_model_name == "User1":
            ...
            rrv_p0     = RooRealVar("rrv_p0_User1"+label+"_"+self.channel,"rrv_p0_User1"+label+"_"+self.channel, 15, 0, 30);
            if self.wtagger_label=="HP":
...
#        banner = TLatex(0.18,0.96,"CM                                          L = 19.7 fb^{-1} at #sqrt{s} = 8 TeV");
    ...
    def legend4Plot(self, plot, left=1, isFill=1, x_offset_low=0., y_offset_low=0., x_offset_high =0., y_offset_high =0., TwoCoulum =1.):
        ...
        if   self.categoryID == -2: legHeader="(e#nu, 1JLP)";
...
objName ==objName_before ):
    ...
    def GetLumi(self):
        ...
        elif self.channel=="mu": return 1.0;
    ...
    def fit_Signal(self,model_narrow="DoubleCB_v1",model_width="BWDoubleCB"):
        ...
        #self.fit_mlvj_model_single_MC(self.file_signal,"_%s_xww"%(self.signal_sample),"_signal_region","Gaus_v1", 0, 0, 0, 1);
...
def pre_limit_simple(channel):
    ...
    #pre_limit_sb_correction_without_systermatic(channel,"MWp_1000_bb",900,1100,40,130, 800,3500,"ExpN","ExpTail")
    #pre_limit_sb_correction_without_systermatic(channel,"MWp_2000_bb",1900,2100,40,130, 800,3500,"ExpN","ExpTail")
    pre_limit_sb_correction_without_systermatic(channel,"RSGravitonToWW_1000",900,1100,40,130, 700,5000,"ExpN","ExpTail")
    #pre_limit_sb_correction_without_systermatic(channel,"RSGravitonToWW_2000",1900,2100,40,130, 700,5000,"ExpN","Exp")
